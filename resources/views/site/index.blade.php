...
<div class="container">
    ...
    <section id="about">
        ...
        <h3>Key Features</h3>
        <ul>
            <li><strong>Authentication & Security</strong>: Secure token-based authentication using Laravel Sanctum.
            </li>
            <li><strong>Authorization</strong>: Strict Role-Based Access Control (RBAC) using Policies to ensure data
                isolation (users cannot access other users' data).
            </li>
            <li><strong>Clean Architecture</strong>: Implementation of a Service Layer pattern for better separation of
                concerns.
            </li>
            <li><strong>Data Transformation</strong>: API Resources to standardize JSON responses and hide sensitive
                internal data.
            </li>
    ...
    <section id="architecture">
        ...
        <ol>
            <li><strong>Service Layer Pattern</strong>: Business logic is encapsulated in <code>Services</code>, keeping
                <code>Controllers</code> thin and focused only on HTTP handling.
            </li>
            <li><strong>Form Request Validation</strong>: Validation logic is decoupled from controllers using dedicated
                Request classes.
            </li>
            <li><strong>API Resources</strong>: Data is transformed cleanly before being sent to the client, ensuring a
